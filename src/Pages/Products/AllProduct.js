...
const Product = () => {
    ...
    return (
        <div className='m-2 p-3'>
            <h2 className='text-center text-4xl my-3 text-blue-600 font-bold'>All Products</h2>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
                {
                    products?.map(product => <div key={product.product_id} className="card lg:max-w-lg bg-base-100 shadow-xl">
            ...
            <div className="card-actions justify-center mt-5">
                <Link to='/' className="btn btn-outline border-green-700 text-xl w-full max-w-md my-2">
                    Back to Home
                </Link>
            </div>
        </div>
